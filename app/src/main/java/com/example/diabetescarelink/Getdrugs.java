...
import com.example.diabetescarelink.Adapters.DrugsAdapter;
...
public class Getdrugs extends AppCompatActivity {
    private static final String DRUGS_LIST_URL = "http://192.168.1.104/dcl/drugs.php";
...
//        setSupportActionBar(toolbar);
        ...
        adapter = new DrugsAdapter(this, mData);
    ...
    private void loaddrugs() {
        StringRequest stringRequest = new StringRequest(Request.Method.GET, DRUGS_LIST_URL,
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            for (int i = 0; i < drugs.length(); i++) {
                                ...
                                String drug = object.getString("drug");
                                String place = object.getString("place");
                                String cost = object.getString("cost");


                                DrugsModel drugsModel = new DrugsModel(id,drug,cost,place);
                                mData.add(drugsModel);
                                error_message.setVisibility(View.GONE);
                                //Orders_Model orders_model = new Orders_Model(food_name, food_description, food_price, id);
                                // mData.add(orders_model);
                            }

                            adapter = new DrugsAdapter(Getdrugs.this, mData);
                            recyclerView.setAdapter(adapter);
...
//                            error_message.setVisibility(View.VISIBLE);
                            error_message.setVisibility(View.VISIBLE);
                            error_message.setVisibility(View.VISIBLE);
                            Toast.makeText(Getdrugs.this, "shhhhhiiit" + e.toString(), Toast.LENGTH_LONG).show();
                        }
                    }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                error_message.setVisibility(View.VISIBLE);
                error_message.setVisibility(View.VISIBLE);
                Toast.makeText(Getdrugs.this, "could not load, please check your" + error.toString(), Toast.LENGTH_LONG).show();
            }
        });
