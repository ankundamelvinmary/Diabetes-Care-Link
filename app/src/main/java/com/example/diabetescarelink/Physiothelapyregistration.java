...
public class Physiothelapyregistration extends AppCompatActivity {
    TextView header,patient_reg,register_link;
    EditText fullnames,email,contact,location,password;
    Button register_btn;
    private static String SUBMIT_URL = "http://192.168.1.104/dcl/physiothelapyreg.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_physiothelapyregistration);
        ...
        register_link.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent register_link = new Intent(getApplicationContext(),physiothelapistlogin.class);
        ...
        register_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
               Sendphysiothelapyreg();
            }
        });

    }

    private void Sendphysiothelapyreg() {
