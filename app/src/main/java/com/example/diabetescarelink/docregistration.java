...
public class docregistration extends Activity {
    TextView header,patient_reg,reg_link;
    EditText firstname,lastname,age,sex,district,healthcenter,email,contact,password;
    Button register_btn;
    private static String SUBMIT_URL = "http://192.168.1.104/dcl/docreg.php";
    private ProgressBar loading;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.docregistration);
        ...
        reg_link.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(docregistration.this,doclogin.class);
