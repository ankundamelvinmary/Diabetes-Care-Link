...
public class Manicuristregistration extends AppCompatActivity {
    ...
    private static String URL_MANICURIST = "http://192.168.11.103/dcl/manicuristreg.php";


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_manicuristregistration);
    ...
    private void Register(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_MANICURIST,
